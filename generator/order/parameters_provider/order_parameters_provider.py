...
from config.constant.datetime import *
from config.constant.linear_congruent import *
from config.constant.identifier import *
from config.constant.direction import *
from config.constant.status import *
from config.constant.currency import *
...
class OrderParametersProvider:
	...
	def generate_initial_px(self):
		...
		initial_px = round(initial_px, Config.digit.px_digits)
	...
	def generate_fill_px(self, initial_px):
		...
		fill_px = round(fill_px, Config.digit.px_digits)
	...
	def generate_initial_volume(self):
		...
		initial_volume = round(initial_volume, Config.digit.volume_digits)
	...
	def generate_fill_volume(self, initial_volume):
		...
		fill_volume = round(fill_volume, Config.digit.volume_digits)
