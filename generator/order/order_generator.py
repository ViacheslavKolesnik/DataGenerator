...
class OrderGenerator(Generator):
	...
	def generate(self, amount):
		...
		self.__generate_zone_dependent_order(order_records, Config.order.number_of_orders_zone_red, self.red_zone_order_factory, amount, current_number_of_generated_values)
		...
		self.__generate_zone_dependent_order(order_records, green_zone_right_border_number, self.green_zone_order_factory, amount, current_number_of_generated_values)
		current_number_of_generated_values = self.total_number_of_generated_values - number_of_previously_generated_values

		self.__generate_zone_dependent_order(order_records, Config.order.number_of_orders_total, self.blue_zone_order_factory, amount, current_number_of_generated_values)
